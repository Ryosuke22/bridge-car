      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto space-y-8 animate-slide-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Button variant="hero" size="xl" onClick={onScrollToForm} className="group">
              <Car className="w-5 h-5 group-hover:scale-110 transition-transform" />
              車の査定を申し込む
            </Button>
            <Button variant="heroOutline" size="xl" onClick={onScrollToForm} className="group">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <button onClick={onScrollToForm} className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
