      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            ...
            <br />
            そのため国内相場に縛られない適正価格で買取できるのです。
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => <div key={feature.title} className="group p-6 rounded-2xl bg-gradient-to-b from-secondary/50 to-secondary/20 border border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 animate-fade-in" style={{
